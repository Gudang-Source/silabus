    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        <div class="box-body">
          ...
          <div class="form-group">
                <label>Hari</label>
                <select class="form-control select2" style="width: 100%;" id="hari">
          <?php
          $query = mysql_query("select * from tbhari");
          while ($data = mysql_fetch_assoc($query)) {
            echo '<option value="'.$data['idhari'].'">'.$data['hari'].'</option>';
          }
          ?>
                </select>
              </div>
...
<script>
  ...
  $(document).ready(function(){
    ...
    $('.view_data').click(function(){
      ...
      // memulai ajax
      $.ajax({
        url: 'view2.php',  // set url -> ini file yang menyimpan query tampil detail data siswa
        method: 'post',   // method -> metodenya pakai post. Tahu kan post? gak tahu? browsing aja :)
        data: {gedung:gedung, idwaktu:waktu, idwaktu2:waktu2, idhari:idhari, keterangan:keterangan},    // nah ini datanya -> {id:id} = berarti menyimpan data post id yang nilainya dari = var id = $(this).attr("id");
